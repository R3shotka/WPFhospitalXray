...
namespace DAL.Migrations
{
    ...
    [Migration("20260518142823_AddModelVersions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entity.AnalysisResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Entity.DetectionBox", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Entity.MedicalImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Entity.ModelVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double?>("Map50")
                        .HasColumnType("float");

                    b.Property<double?>("Map5095")
                        .HasColumnType("float");
                    ...
                    b.Property<string>("OldDatasetPath")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<string>("TrainingDatasetPath")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("TrainingRunPath")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("DAL.Entity.AnalysisResult", b =>
                {
                    ...
                    b.HasOne("DAL.Entity.MedicalImage", "MedicalImage")
            ...
            modelBuilder.Entity("DAL.Entity.DetectionBox", b =>
                {
                    b.HasOne("DAL.Entity.AnalysisResult", "AnalysisResult")
                        .WithMany("DetectionBoxes")
            ...
            modelBuilder.Entity("DAL.Entity.MedicalCard", b =>
                {
                    b.HasOne("DAL.Entity.Patient", "Patient")
                        .WithOne("MedicalCard")
                        .HasForeignKey("DAL.Entity.MedicalCard", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DAL.Entity.MedicalImage", b =>
                {
                    ...
                    b.Navigation("RetrainingRequests");
                });
